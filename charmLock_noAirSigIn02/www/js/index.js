...
var app = {
    ...
    startTimer: false,
    isValid: undefined,
    repeates: 4,   //how many times the signature was repeated for training
    //not using these yet
    startTime: undefined,
    endTime: undefined,
    gbMove: false,
...
*/
    onDeviceReady: function() {
        ...
        var listPorts = function() {
            ...
            bluetoothSerial.list(
                function(results) {
                    // uncomment this - too much for screen
                    ...
                    if (results[i].address) {
                        ...
                        //these guys on edit page will fail to connect becaue of adress
    ...
    appendtoDiv: function(whichButton, whatDiv){
     ...
     connect: function () {
        app.display("disconecting from others.. ")
        //first disconect from previous if it was connected 
        app.disconnect();
...
*/
    ...
    //when pressing confirmed button, notifing user
    confirmed:function(){
    ...
    tryAgain: function(){
        ...
        app.changeButton("validButton", "trying to ulock..", "#f39c12");
        //send comand for unlocking again
        app.send0();
        //give it a sec and reset the button
        setTimeout(function(){ app.changeButton("validButton", "Didn't ulock? Tap!", "#f39c12"); },  2000);
    },
...
*/
    ...
    appendParagraph:function(buttonId, text){
       //  var thatButton1 = document.getElementById(buttonId1);
       //  var textToDisplay1 = text1;
       //  var thatButtonText1 = document.createTextNode(textToDisplay1); // text node
       // // thatButton.innerHTML = "";
       //  thatButton1.appendChild(thatButtonText1); //append textNode to btn
        //recordingButton.setAttribute( "class", "tan"); //me perke no?
        //change the button color to some red
       ...
       // var comment = "woohooo! go me.";
        ...
        document.getElementById(buttonId).appendChild(newParagraph);
...
*/
    stopRecording:function(shouldValidate){
        ...
        var repeatsMinusOne = app.repeates - 1;

        //just for documentation video, sorry for the fu
        if(app.repeates === 3){
            app.changeButton("bigTrainButton", "movements too different!" , "#f39c12");
            app.appendParagraph("bigTrainButton", " try again! " );
        } else if (app.repeates != 2){  
            app.changeButton("bigTrainButton", "Signature recorded!" , "#E74C3C");
            app.appendParagraph("bigTrainButton", "repeat " + repeatsMinusOne + " more times ");

        } else {
            app.changeButton("bigTrainButton", "Signature recorded!", "#E74C3C");
            app.appendParagraph("bigTrainButton", "repeat ONE more time ");
       ...
       // setTimeout(andWhat, 1000);
        if(shouldValidate){
            ...
            if(app.repeates>1){
                app.repeates--;
                app.clear();
                app.display("repeat: " + app.repeates + " times");
                console.log(' now repeates: '+ app.repeates);            
            } else{
    ...
    timing: function(){
        if(!app.signatureToCheck){
            ...
            //go train
            console.log(' repeate ' + repeate + "times");
        }
    },
/*
...
*/
    ...
    validating:function(){
        ...
        //change the button look to be ready for next try
        app.changeButton("bigButton", "Touch to start", "#e74c3c");
        app.changeButton("bigTrainButton", "Touch to start", "#e74c3c");


        //switch to validating page
        app.showValidatingPage();
    ...
    goHome: function(){
        ...
        app.changeButton("validButton", "Didn't ulock? Tap!", "#f39c12");
...
*/  
    ...
    showStartPage: function() {
        ...
        validPage.hidden = true;
        invalidPage.hidden = true; 
        //reset this, somethimes just jumpst to startPage   
        app.repeates = 4;
